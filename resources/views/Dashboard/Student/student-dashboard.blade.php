                ...
                <nav class="mt-5 flex-1" aria-label="Sidebar">
                    <div class="space-y-1 px-2">
                        ...
                        <a href="/my-attendance"
                            class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md {{Route::current()->getName() === 'attendance' ?'bg-gray-200' : ''}}">
                ...
                <div class="flex flex-col items-start">
                    <div class="ml-3">
                        <p class="text-base font-medium text-gray-700 group-hover:text-gray-900">
                            {{ $user?->first_name . ' ' . $user?->last_name }} - <span class="capitalize">{{ $user?->role}}</span></p>
